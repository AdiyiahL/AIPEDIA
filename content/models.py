...
class Questions(models.Model):
    ...
    q1_o1 = models.CharField(verbose_name="question1", max_length=1000)
    q1_o2 = models.CharField(verbose_name="question1", max_length=1000)
    q1_o3 = models.CharField(verbose_name="question1", max_length=1000)
    ...
    q2_o1 = models.CharField(verbose_name="question1", max_length=1000)
    q2_o2 = models.CharField(verbose_name="question1", max_length=1000)
    q2_o3 = models.CharField(verbose_name="question1", max_length=1000)
    ...
    q3_o1 = models.CharField(verbose_name="question1", max_length=1000)
    q3_o2 = models.CharField(verbose_name="question1", max_length=1000)
    q3_o3 = models.CharField(verbose_name="question1", max_length=1000)
